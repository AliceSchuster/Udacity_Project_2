...
def load_data(messages_filepath, categories_filepath):
    """
    Function: Load and merge message and categories data
    Args：
...
def clean_data(df):
    """
    Function: Clean data by creating one column for each category and removing duplicates
    Args:
        df: raw dataset
    Return:
        df: clean dataset
...
def save_data(df, database_filename):
    """
    Function: Save the clean dataset into an sqlite database
    Args:
        df: clean dataset
    Return:
        None
